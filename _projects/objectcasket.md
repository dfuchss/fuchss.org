...
The aim is to provide a simple object mapper, as it is used for small projects. More information is available at [GitHub](https://github.com/foxhutch/object-casket).

## Maven & Co.

If you want to use Maven or a similar build tool, add the following code to your pom:
