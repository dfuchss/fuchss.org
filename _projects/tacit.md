...
![DM view](/assets/projects/tacit/overview.png){:width="100%" style="border-radius: 8px;"}

### Invites

![Invite view](/assets/projects/tacit/invite.png){:width="100%" style="border-radius: 8px;"}

### Chatting

![Chat view](/assets/projects/tacit/chatting.png){:width="100%" style="border-radius: 8px;"}

### Emoji picker while typing :)

![Emoji picker](/assets/projects/tacit/emoji_picker.png){:width="100%" style="border-radius: 8px;"}
...
![Create guild](/assets/projects/tacit/guild_create.png){:width="100%" style="border-radius: 8px;"}

#### Guild overview

![Guild overview](/assets/projects/tacit/guild_ui.png){:width="100%" style="border-radius: 8px;"}

#### Invite to guild

![Guild invite](/assets/projects/tacit/guild_invite.png){:width="100%" style="border-radius: 8px;"}

### About

![About](/assets/projects/tacit/about.png){:width="100%" style="border-radius: 8px;"}
