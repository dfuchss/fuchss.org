...
date: 2023-11-17
description: My post on matrix-joinlink at TWIM 17.11.2023
tags: matrix
featured: false
---
...
matrix-joinlink simplifies the process of inviting users to non-public spaces.
...
![](../../assets/projects/joinlink/help.png)

#### Creation of Join Links (with Developer Mode Details)

![](../../assets/projects/joinlink/creation.png)

#### Entering a Join Link Room

![](../../assets/projects/joinlink/joined.png)

Feel free to test the bot and raise any issue using GitHub or using the development room that is mentioned in the project's [README](https://github.com/dfuchss/matrix-joinlink). Also consult the README for technical details.
