...
# [Architecture Documentation Consistency](https://ardoco.de/)
In this research project, we aim to provide consistency analyses between different kind of documentation, namely models and informal (textual) documentation.
