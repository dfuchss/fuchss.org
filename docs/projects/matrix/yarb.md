...
# [YARB](https://github.com/dfuchss/YARB)
This bot can be used to create reminders for a specific time at a day. It uses the [Trixnity](https://trixnity.gitlab.io/trixnity/) framework.
...
![Functions](/projects/yarb/functions.png)
